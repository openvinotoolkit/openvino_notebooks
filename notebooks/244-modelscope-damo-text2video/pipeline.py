...
class OVTextToVideoSDPipeline(DiffusionPipeline):
    def __init__(
            self,
            vae_decoder: CompiledModel,
            post_quant_conv: CompiledModel,
            text_encoder: CompiledModel,

...
* Quantizing the model with NNCF with the [Post-training Quantization with NNCF Tool](https://docs.openvino.ai/2023.0/nncf_ptq_introduction.html) API in OpenVINO.

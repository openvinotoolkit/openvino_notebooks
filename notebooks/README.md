...
- [Convert and Optimize YOLOv8 real-time object detection with OpenVINO™](./yolov8-object-detection/yolov8-object-detection.ipynb)
- [YOLOv8 Oriented Bounding Boxes Object Detection with OpenVINO™](./yolov8-obb/yolov8-obb.ipynb)
- [Convert and Optimize YOLOv8 keypoint detection model with OpenVINO™](./yolov8-keypoint-detection/yolov8-keypoint-detection.ipynb)
- [Convert and Optimize YOLOv8 instance segmentation model with OpenVINO™](./yolov8-instance-segmentation/yolov8-instance-segmentation.ipynb)
...
- [Convert and Optimize YOLOv11 real-time object detection with OpenVINO™](./yolov11-object-detection/yolov11-object-detection.ipynb)
- [Convert and Optimize YOLOv11 keypoint detection model with OpenVINO™](./yolov11-keypoint-detection/yolov11-keypoint-detection.ipynb)
- [Convert and Optimize YOLOv11 instance segmentation model with OpenVINO™](./yolov11-instance-segmentation/yolov11-instance-segmentation.ipynb)

...
[DepthAnything](https://huggingface.co/tasks/depth-estimation) is a highly practical solution for robust monocular depth estimation. Without pursuing novel technical modules, this project aims to build a simple yet powerful foundation model dealing with any images under any circumstances.
...
There are two version of DepthAnything models. The notebook includes the demonstration of work both [Depth Anything V1](https://depth-anything.github.io/) and [Depth Anything V2](https://depth-anything.github.io/). Depth Anything V2 significantly outperforms V1 in fine-grained details and robustness.

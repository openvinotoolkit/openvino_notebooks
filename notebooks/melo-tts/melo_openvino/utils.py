...
def get_text_for_tts_infer(text, language_str, hps, device, symbol_to_id=None, bert_dir=None):
    ...
    if getattr(hps.data, "disable_bert", False):
        ...
        bert = get_bert(norm_text, word2ph, language_str, device, bert_dir=bert_dir)
        del word2ph

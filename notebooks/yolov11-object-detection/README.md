...
This tutorial explains how to convert and optimize the [YOLOv11 PyTorch models](https://docs.ultralytics.com/models/yolo11/) with OpenVINO for [object detection scenarios](https://docs.ultralytics.com/tasks/detect/).
...
You can also try tutorials, which considered using instance segmentation and keypoint detection scenarios with OpenVINO Runtime:
...
<img referrerpolicy="no-referrer-when-downgrade" src="https://static.scarf.sh/a.png?x-pxid=5b5a4db0-7875-4bfb-bdbd-01698b5b1a77&file=notebooks/yolov11-object-detection/README.md" />

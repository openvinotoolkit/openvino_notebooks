...
| [123-pytorch-post_training_quantization_and_sparsity_pot](notebooks/123-pytorch-post_training_quantization_and_sparsity_pot/) | Use Post-training Optimization Tool (POT) to quantize and sparsify PyTorch model 

...
| [106-quantize-omz-model-resnet-50-tf](notebooks/106-quantize-omz-model-resnet-50-tf/)<br>[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/openvinotoolkit/openvino_notebooks/HEAD?filepath=notebooks%2F106-quantize-omz-model-resnet-50-tf%2F106-quantize-omz-model-resnet-50-tf.ipynb) | Optimize and quantize the Open Model Zoo resnet-50-tf model ||

...
| [125-torchvision-zoo-to-openvino](notebooks/125-torchvision-zoo-to-openvino/)| Convert torchvision classification and semantic segmentation models to OpenVINO IR |

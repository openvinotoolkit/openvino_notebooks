...
| [107-quantize-omz-model-ssd_mobilenet_v1_coco](notebooks/107-quantize-omz-model-ssd_mobilenet_v1_coco/)<br>[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/openvinotoolkit/openvino_notebooks/HEAD?filepath=notebooks%2F107-quantize-omz-model-ssd_mobilenet_v1_coco%2F107-quantize-omz-model-ssd_mobilenet_v1_coco.ipynb) | Optimize and quantize the Open Model Zoo ssd_mobilenet_v1_coco model ||

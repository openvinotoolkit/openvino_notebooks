...
This is [Qwen3-VL-32B-Instruct](https://huggingface.co/Qwen/Qwen3-VL-32B-Instruct) model converted to the [OpenVINO™ IR](https://docs.openvino.ai/2025/documentation/openvino-ir-format.html) (Intermediate Representation) format with weights compressed to INT8 by [NNCF](https://github.com/openvinotoolkit/nncf).
...
model_id = "OpenVINO/Qwen3-VL-32B-Instruct-int8-ov"
...
model_id = "OpenVINO/Qwen3-VL-32B-Instruct-int8-ov"
model_path = "Qwen3-VL-32B-Instruct-int8-ov"

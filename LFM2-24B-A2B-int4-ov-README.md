...
* Original model: [LFM2-24B-A2B](https://huggingface.co/LiquidAI/LFM2-24B-A2B)
...
This is [LFM2-24B-A2B](https://huggingface.co/LiquidAI/LFM2-24B-A2B) model converted to the [OpenVINO™ IR](https://docs.openvino.ai/2025/documentation/openvino-ir-format.html) (Intermediate Representation) format with weights compressed to INT4 by [NNCF](https://github.com/openvinotoolkit/nncf).
...
model_id = "OpenVINO/LFM2-24B-A2B-int4-ov"
...
model_id = "OpenVINO/LFM2-24B-A2B-int4-ov"
model_path = "LFM2-24B-A2B-int4-ov"
...
Check the original model card for [limitations](https://huggingface.co/LiquidAI/LFM2-24B-A2B).

## Legal information

The original model is distributed under [lfm1.0](https://www.liquid.ai/lfm-license) license. More details can be found in [LFM2-24B-A2B](https://huggingface.co/LiquidAI/LFM2-24B-A2B).

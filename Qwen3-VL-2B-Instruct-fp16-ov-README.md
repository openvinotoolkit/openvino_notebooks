...
This is [Qwen3-VL-2B-Instruct](https://huggingface.co/Qwen/Qwen3-VL-2B-Instruct) model converted to the [OpenVINO™ IR](https://docs.openvino.ai/2025/documentation/openvino-ir-format.html) (Intermediate Representation) format with weights compressed to FP16.
...
model_id = "OpenVINO/Qwen3-VL-2B-Instruct-fp16-ov"
...
model_id = "OpenVINO/Qwen3-VL-2B-Instruct-fp16-ov"
model_path = "Qwen3-VL-2B-Instruct-fp16-ov"

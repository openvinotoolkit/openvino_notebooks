...
# Qwen3-VL-32B-Instruct-int4-ov

* Model creator: [Qwen](https://huggingface.co/Qwen)
* Original model: [Qwen3-VL-32B-Instruct](https://huggingface.co/Qwen/Qwen3-VL-32B-Instruct)

## Description

This is [Qwen3-VL-32B-Instruct](https://huggingface.co/Qwen/Qwen3-VL-32B-Instruct) model converted to the [OpenVINO™ IR](https://docs.openvino.ai/2025/documentation/openvino-ir-format.html) (Intermediate Representation) format with weights compressed to INT4 by [NNCF](https://github.com/openvinotoolkit/nncf).
...
model_id = "OpenVINO/Qwen3-VL-32B-Instruct-int4-ov"
...
model_id = "OpenVINO/Qwen3-VL-32B-Instruct-int4-ov"
model_path = "Qwen3-VL-32B-Instruct-int4-ov"
...
Check the original [model card](https://huggingface.co/Qwen/Qwen3-VL-32B-Instruct) for limitations.

## Legal information

The original model is distributed under [Apache License 2.0](https://huggingface.co/Qwen/Qwen3-VL-32B-Instruct/blob/main/LICENSE) license. More details can be found in the [original model card](https://huggingface.co/Qwen/Qwen3-VL-32B-Instruct).

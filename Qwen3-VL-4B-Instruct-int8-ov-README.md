---
license: apache-2.0
license_link: https://huggingface.co/Qwen/Qwen3-VL-4B-Instruct/blob/main/LICENSE
language:
  - en
  - zh
...
# Qwen3-VL-4B-Instruct-int8-ov

* Model creator: [Qwen](https://huggingface.co/Qwen)
* Original model: [Qwen3-VL-4B-Instruct](https://huggingface.co/Qwen/Qwen3-VL-4B-Instruct)

## Description

This is [Qwen3-VL-4B-Instruct](https://huggingface.co/Qwen/Qwen3-VL-4B-Instruct) model converted to the [OpenVINO™ IR](https://docs.openvino.ai/2025/documentation/openvino-ir-format.html) (Intermediate Representation) format with weights compressed to INT8 by [NNCF](https://github.com/openvinotoolkit/nncf).
...
model_id = "OpenVINO/Qwen3-VL-4B-Instruct-int8-ov"
...
model_id = "OpenVINO/Qwen3-VL-4B-Instruct-int8-ov"
model_path = "Qwen3-VL-4B-Instruct-int8-ov"
...
Check the original [model card](https://huggingface.co/Qwen/Qwen3-VL-4B-Instruct) for limitations.

## Legal information

The original model is distributed under [Apache License 2.0](https://huggingface.co/Qwen/Qwen3-VL-4B-Instruct/blob/main/LICENSE) license. More details can be found in the [original model card](https://huggingface.co/Qwen/Qwen3-VL-4B-Instruct).

...
| [101-tensorflow-to-openvino](notebooks/101-tensorflow-to-openvino/)<br>[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/openvinotoolkit/openvino_notebooks/HEAD?filepath=notebooks%2F101-tensorflow-to-openvino%2F101-tensorflow-to-openvino.ipynb) |  [102-pytorch-onnx-to-openvino](notebooks/102-pytorch-onnx-to-openvino/) | [103-paddle-onnx-to-openvino](notebooks/103-paddle-onnx-to-openvino-classification/)<br>[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/openvinotoolkit/openvino_notebooks/HEAD?filepath=notebooks%2F103-paddle-onnx-to-openvino-classification%2F103-paddle-onnx-to-openvino-classification.ipynb) | [104-model-tools](notebooks/104-model-tools/)<br>[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/openvinotoolkit/openvino_notebooks/HEAD?filepath=notebooks%2F104-model-tools%2F104-model-tools.ipynb) | 
| -------------------------------------------------------------------------------- | --------------------------------------------------------------------------- | ------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- |  
...
| [106-auto-device](notebooks/106-auto-device/) | 演示如何使用AUTO设备 |
...
| [113-image-classification-quantization](notebooks/113-image-classification-quantization/) | 量化mobilenet图片分类 | 
| [114-quantization-simplified-mode](notebooks/114-quantization-simplified-mode/) | 使用POT在简化模式下量化图片分类模型 |
| [115-async-api](notebooks/115-async-api/) | 使用异步执行改进数据流水线 |
</details>
</p>
...
| [204-named-entity-recognition](notebooks/204-named-entity-recognition/)<br>[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/openvinotoolkit/openvino_notebooks/HEAD?filepath=notebooks%2F204-named-entity-recognition%2F204-named-entity-recognition.ipynb) | 简单文本的命名实体识别 | <img src="https://user-images.githubusercontent.com/33627846/169470030-0370963e-6ad8-49e3-be7a-f02a2c677733.gif" width="225"> |
...
| [214-vision-paddle-classification](notebooks/214-vision-paddle-classification/)<br>[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/openvinotoolkit/openvino_notebooks/HEAD?filepath=notebooks%2F214-vision-paddle-classification%2F214-vision-paddle-classification.ipynb) | 利用OpenVINO进行PaddlePaddle图像分类| |
| [215-image-inpainting](notebooks/215-image-inpainting/)<br> | 用绘画中的图像填充缺失像素 | <img src="https://user-images.githubusercontent.com/4547501/167121084-ec58fbdb-b269-4de2-9d4c-253c5b95de1e.png" width=225> |
...
| [218-vehicle-detection-and-recognition](notebooks/218-vehicle-detection-and-recognition/)<br> | 利用OpenVINO及预训练模型检测和识别车辆及其属性 | <img src = "https://user-images.githubusercontent.com/47499836/163544861-fa2ad64b-77df-4c16-b065-79183e8ed964.png" width=225> |
| [219-knowledge-graphs-conve](notebooks/219-knowledge-graphs-conve/)<br> | 使用OpenVINO优化知识图谱嵌入模型(ConvE) ||
...
| [221-machine-translation](notebooks/221-machine-translation)<br> | 从英语到德语的实时翻译 |  |
| [222-vision-image-colorization](notebooks/222-vision-image-colorization/)<br> | 使用OpenVINO及预训练模型对黑白图像染色 | <img src = "https://user-images.githubusercontent.com/18904157/166343139-c6568e50-b856-4066-baef-5cdbd4e8bc18.png" width=225> |

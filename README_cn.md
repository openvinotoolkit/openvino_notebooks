...
| [128-openvino-tokenizers](notebooks/128-openvino-tokenizers/)<br>[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/openvinotoolkit/openvino_notebooks/HEAD?filepath=notebooks%2F128-opnevino-tokenizers%2F128-opnevino-tokenizers.ipynb)<br>[![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/openvinotoolkit/openvino_notebooks/blob/main/notebooks/128-openvino-tokenizers/128-opnevino-tokenizers.ipynb)| 使用 OpenVINO 分词器将文本处理集成到 OpenVINO 管道中 |
<div id='-model-demos'/>

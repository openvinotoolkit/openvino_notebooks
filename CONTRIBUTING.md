...
We recommend to use embedded URL for image data since GitHub limits the size of files allowed in repositories. If you attempt to add or update a file that is larger than 50 MB, you will receive a warning from Git.
For images to be placed in data, it is recommeded to use embedded URL generated by GitHub.
